<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/unitedMasterPage2.Master"  CodeBehind="userProfile.aspx.cs" Inherits="js.userProfile" %>
        ...
        <section role="main" class="content-body">
            ...
            <div class="row">
                        ...
                        <div class="tab-content">
                                        ...
                                        <ol class="tm-items">
                                            <li >
                                                <div class="tm-box" style="background-color: #1d2127"  >
                                                    ...
                                                    <div class="thumbnail-gallery">
                                                        <a class=" lightbox" href="images/slogan.jpg" data-plugin-options='{ "type":"image" }'>
                                                            <img class="img-responsive" width="215" src="images/slogan.jpg">
                                                            <span class="zoom">
																		<i class="fa fa-search"></i>
																	</span>
                                                        </a>
                            ...
                            <div id="changepassword" class="tab-pane">
                                ...
                                <form id="chgPassForm" method="POST" runat="server">
                                    ...
                                    <br/>
                                    <p class="text-center mt-lg">Wish to cancel? <a href="userProfile.aspx">Go Back!</a>
                ...
                <div class="col-md-12 col-lg-3" style="background-color: white">
                    <h4 class="mb-md" style="color: black;padding-top: 10px;padding-bottom: 5px;text-decoration-line: underline">Account Details</h4>

                    <ul class="simple-card-list mb-xlg" >
                        <li class="primary" style="background-color: #00BFFF">
                            <h3 style="color: yellow" id="item_in_cart" runat="server"></h3>
                            <p style="color: black;font-weight: bolder  ">Item In Cart</p>
                        </li>

            
                        <%--<li class="primary" style="background-color: #1E90FF">
                            <h3 style="color:lightgreen" id="item_in_wishlist" runat="server"></h3>
                            <p style="color: black;font-weight: bolder  " >Item On WishList </p>
                        </li>--%>
                        <li class="primary" style="background-color: #6A5ACD">
                            <h3 style="color: #9effff" id="item_trans_history" runat="server"></h3>
                            <p style="color: black;font-weight: bolder  ">Payment History </p>
                        </li>
