<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountSwitching.aspx.cs" Inherits="js.AccountSwitching" %>
					...
					<div class="panel-body" style="background-color:rgba(255, 255, 255, 0.7);">
							...
							<div class="row">
								...
								<div class="col-xs-9 text-right" >
									<asp:Button ID="submit" OnClick="create_acc_click"  runat="server" type="submit" class="btn btn-primary" style="background-color:hotpink;border-color:hotpink;color:white;font-weight:500" Text="Login As ADMIN"></asp:Button>
								</div>
							</div>
						</form>
					</div>
